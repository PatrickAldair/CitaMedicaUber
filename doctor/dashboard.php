...
require '../db.php';
$stmt = $pdo->prepare("
  SELECT c.id, c.fecha, u.nombres, u.apellidos 
  FROM citas c 
        ...
        <?php foreach ($citas as $c): ?>
          <tr>
            ...
            <td class="text-center">
              <a href="confirmar.php?id=<?= $c['id'] ?>&res=aceptada" class="btn btn-success btn-sm" style="margin-right: 6px;">Aceptar</a>
              <a href="confirmar.php?id=<?= $c['id'] ?>&res=rechazada" class="btn btn-danger btn-sm">Rechazar</a>
            </td>
          </tr>
        <?php endforeach; ?>
      </tbody>
