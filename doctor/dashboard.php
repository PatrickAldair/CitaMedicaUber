...
<body style="background-color: #e6f7ff; padding-top: 80px; font-family: 'Segoe UI', sans-serif;">
    ...
    <div
        style="position: fixed; top:0; width:100%; background:#00aaff; color:white; padding:1rem 2rem; display:flex; justify-content:space-between; align-items:center; z-index:1000;">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <form action="proponer_precio.php" method="POST" class="d-flex justify-content-center gap-2">
                            ...
                            <input type="number" name="precio" class="form-control form-control-sm" style="width:100px;"
                                min="1" step="0.10" placeholder="S/." required>
