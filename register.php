...
<div class="card">
    ...
    <form method="POST" action="">
        ...
        <div id="camposDoctor" style="display: none;">
            <div class="mb-3">
                <select name="especialidad_id" id="especialidad_id" class="form-select" onchange="cargarServicios()" required>
            ...
            <div class="mb-3">
                <textarea name="servicios" id="servicios" class="form-control" readonly placeholder="Servicios ofrecidos (autocompletado)"></textarea>
            </div>
        </div>
        ...
        <div id="camposPaciente" style="display: block;">
            ...
            <div class="mb-3">
                <textarea name="enfermedades_previas" class="form-control" placeholder="Enfermedades previas o crónicas"></textarea>
            </div>
            <div class="mb-3">
                <textarea name="medicamentos" class="form-control" placeholder="Medicamentos que toma actualmente"></textarea>
            </div>
            <div class="mb-3">
                <textarea name="antecedentes_familiares" class="form-control" placeholder="Antecedentes familiares (diabetes, hipertensión, etc.)"></textarea>
            </div>
            <div class="mb-3">
                <textarea name="cirugias" class="form-control" placeholder="Cirugías anteriores (si aplica)"></textarea>
            </div>
            <div class="mb-3">
                <textarea name="otros_datos" class="form-control" placeholder="Otros datos relevantes (hábitos, etc.)"></textarea>
            </div>
        </div>
